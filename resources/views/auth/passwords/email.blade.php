        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 vertical-align d-none d-lg-block">
                    <img class="img-fluid" src="{{ asset('frontend/img/fimp.png') }}" width="500px" height="500px">
                </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="form-group">
                                    <div class="row m-0">
                                        ...
                                        <div class="col-6">
                                            <a href="{{ url('login') }}" class="float-right forgot-text">Back to
                                                login?</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-lg btn-block login-page-button">Send Password Reset
                                        Link</button>
                                </div>
                                ...
                                <div class="form-group">
                                    <a href="{{ url('login/facebook') }}"
                                        class="btn btn-lg btn-block social-btn facebook-btn">
                                        <div class="row">
                                            <div class="col-3">
