        ...
        <div class="row" style="flex-grow: 1;">
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2" id="logo">
                ...
                <a href="{{ route('home') }}" class="float-xl-right"><img
                        src="{{ asset('frontend/img/aolp_logo.png') }}" width="100" height="23" /></a>
            </div>
    ...
    <footer id="main-footer">
        <div class="row m-0">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 text-center mt-4">
                <img src="{{ asset('frontend/img/footer_logo.png') }}" class="img-fluid" width="210"
                    height="48">
                <br>
                <span id="c-copyright">
                    Copyright © 2021, AOLP. All rights reserved.
                </span>
            </div>
        </div>
    </footer>
                ...
                <div class="becomeInstructorForm">
                    <form id="becomeInstructorForm" class="form-horizontal" method="POST"
                        ...
                        <div class="px-4 py-2">
                            ...
                            <div class="form-group">
                                <label>Bio</label>
                                <textarea class="form-control form-control" placeholder="Bio"
