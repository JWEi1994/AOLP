...
<body>
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center">
                <img class="navbar-brand-logo" src="{{ asset('backend/assets/images/b_logo.png') }}" title="AOLP">
                <span class="navbar-brand-text hidden-xs-down">AOLP</span>
            </div>
    ...
    <footer class="site-footer">
        <div class="site-footer-legal">© {{ date('Y') }} AOLP</div>
    </footer>
    <!-- Core  -->
