                ...
                <div class="col-xl-7 offset-xl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    ...
                    <div class="row mb-1">
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-4">
                            <img src="@if (Storage::exists($course->thumb_image)){{ asset('storage/' . $course->thumb_image) }}@else{{ asset('backend/assets/images/no_image_thumb.png') }}@endif" width="120" height="90">
                        </div>
                    ...
                    <div
                        class="col-xl-7 offset-xl-2 col-lg-8 offset-lg-2 col-md-9 offset-md-2 col-sm-9 offset-sm-2 col-11 offset-1">
                        <form method="POST" action="{{ route('payment.form') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-lg btn-block social-btn facebook-btn">
                                    <div class="row">
                                        <div class="col-3">
                                            <i class="@if ($course->price == 0.0) fas fa-cart-arrow-down @else fab fa-paypal  @endif float-right"></i>
                                        </div>
                                        <div class="col-9">
                                            <span>
                                                @if ($course->price == 0.0)
