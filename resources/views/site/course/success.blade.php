        ...
        <div class="breadcrumb-container">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Purchase Status</li>
                </ol>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 not-found-col">
                    @if ($status == 'success')
                        ...
                        <a href="{{ route('course.learn', $course->course_slug) }}" class="btn btn-aolp-cview mt-3">Go to
                            course learn page</a>
                    @else
                        <span><i class="fas fa-thumbs-down"></i></span>
                        <h6 class="my-3">Sorry! Your transaction was failed...</h6>
                        <a href="{{ route('course.view', $course->course_slug) }}" class="btn btn-aolp-cview mt-3">Return
                            to course</a>
                    @endif
                </div>
            </div>
