...
@section('content')
    ...
    <div class="container-fluid p-0 home-content">
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-2 col-md-3 d-none d-md-block">
                    <form method="GET" action="{{ route('course.list') }}" id="courseList">
                        ...
                        @if ($_GET)
                            <a href="{{ route('course.list') }}" class="clear-filters"><i
                                    class="fa fa-sync"></i>&nbsp;Clear filters</a>
                        @endif
                                ...
                                <li>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input filter-results"
                                            id="{{ 'cat-' . $category->id }}" name="category_id[]"
                                            value="{{ $category->id }}" @if (isset($_GET['category_id']))
                        ...
                        <li>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input filter-results"
                                    ...
                                    value="{{ $instruction_level->id }}" @if (isset($_GET['instruction_level_id']))
            ...
            <?php $levels = [
                '0-0' => 'Free',
                '1-50' => 'Less than RM 50',
                '50-99' => 'RM 50 - RM 99',
                '100-199' => 'RM 100 - RM 199',
                '200-299' => 'RM 200 - RM 299',
                '300-399' => 'RM 300 - RM 399',
                '400-499' => 'RM 400 - RM 499',
                '500' => 'More than RM 500',
            ];
            ?>
            <ul class="ul-no-padding">
                ...
                <li>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input filter-results" id="{{ $l_key }}"
                            name="price_id[]" value="{{ $l_key }}" @if (isset($_GET['price_id']))
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="course-block mx-auto">
                            <a href="{{ route('course.view', $course->course_slug) }}" class="c-view">
                                <main>
                                    <img src="@if (Storage::exists($course->thumb_image)){{ asset('storage/' . $course->thumb_image) }}@else{{ asset('backend/assets/images/no_image_thumb.png') }}@endif">
                                    <div class="col-md-12">
