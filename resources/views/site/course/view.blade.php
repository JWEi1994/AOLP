                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                                <div class="cv-category-detail cv-enroll float-lg-right float-md-right float-sm-right">
                                    <a href="{{ route('course.checkout', $course->course_slug) }}"
                                        class="btn btn-aolp-cview mt-1">Buy Course</a>
                                </div>
                            </div>
                        </div>

                        <div class="course-image mt-2">
                            <img src="@if (Storage::exists($course->course_image)){{ asset('storage/' . $course->course_image) }}@else{{ asset('backend/assets/images/no_image.jpg') }}@endif">
                        </div>
