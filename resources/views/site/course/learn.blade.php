                        ...
                        <div class="row cv-header">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                                <div class="cv-category-detail cv-enroll float-lg-right float-md-right float-sm-right">
                                    <a href="javascript::void(0);" class="btn btn-aolp-cview mt-1" data-toggle="modal"
                            ...
                            <div class="accordion mt-3" id="accordionExample">
                                ...
                                @foreach ($curriculum_sections as $curriculum_section => $curriculum_lectures)
                                    ...
                                    <div class="card mb-2">
                                        ...
                                        <div id="collapseOne-{{ $section_id }}" class="collapse @if ($loop->first) show @endif"
                    ...
                    @if ($video)
                        ...
                        <section class="course_preview_video mt-3">
                            <div class="aligncenter overlay">
                                ...
                                <img src="@if (Storage::exists($file_image_name)){{ asset('storage/'.$file_image_name) }}@else{{ asset('backend/assets/images/no_image.jpg') }}@endif" alt="image description">
                            </div>
                        </section>
                    @endif
                        ...
                        <form id="rateCourseForm" class="form-horizontal" method="POST"
                            ...
                            <div class="px-4 py-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control" placeholder="Comments"
                                        name="comments">{{ $course_rating->comments }}</textarea>
                                </div>
