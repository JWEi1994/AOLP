...
@section('content')
    ...
    <div class="container-fluid p-0 home-content">
        ...
        <?php
        $tabs = ['latestTab' => 'Latest Courses',  'discountTab' => 'Discount Courses'];
        //
        ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <a href="{{ route('course.list') }}" class="btn btn-aolp">Explore Courses</a>
                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="instructor-box mx-auto text-center">
                                <a href="{{ route('instructor.view', $instructor->instructor_slug) }}">
                                    <main>
                                        <img src="@if (Storage::exists($instructor->instructor_image)){{ asset('storage/' . $instructor->instructor_image) }}@else{{ asset('backend/assets/images/no_image_thumb.png') }}@endif">
                                        <div class="col-md-12">
