                        ...
                        <div class="form-group col-md-6">
                            ...
                            <label class="cabinet center-block">
                                <figure class="course-image-container">
                                    ...
                                    <img src="@if (Storage::exists($course->course_image)){{ asset('storage/' . $course->course_image) }}@else{{ asset('backend/assets/images/no_image.jpg') }}@endif" class="gambar img-responsive"
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            //image crop start
            $(".gambar").attr("src", @if (Storage::exists($course->course_image))"{{ asset('storage/' . $course->course_image) }}" @else "{{ asset('backend/assets/images/no_image.jpg') }}" @endif);
