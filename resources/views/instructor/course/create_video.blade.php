    ...
    <div class="page-content">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <form action="{{ route('instructor.course.video.save') }}" id="courseForm" name="frmupload" method="post"
                                        ...
                                        @if ($video)
                                            ...
                                            @else
                                                <blockquote class="blockquote custom-blockquote blockquote-success mt-4">
                                                    <p class="mb-0">No video uploaded</p>
                                                </blockquote>
                                            @endif
                                        @else
                                    ...
                                    <div class="input-group input-group-file" data-plugin="inputGroupFile">
                                        ...
                                        <span class="input-group-btn">
                                            <span class="btn btn-success btn-file">
                                                ...
                                                <input type="file" class="file center-block" name="course_video"
                                                    id="course_video" accept="video/*" />
                                            </span>
                                        </span>
                                    </div>
                                </div>
            ...
            $('#courseForm').ajaxForm({
                ...
                complete: function(xhr) {
                    if (xhr.responseText) {
                        ...
                        var output_video =
                            '<video width="100%" height="100%" controls preload="auto"><source src="' + data.file_link + '" type="video/mp4"></video>';
