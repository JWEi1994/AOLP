...
@section('content')
        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title">
                    <button class="btn btn-success btn-sm" data-target="#withdrawModal" data-toggle="modal" type="button"><i
                            class="icon wb-pencil" aria-hidden="true"></i> Withdraw Request</button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="withdrawModal" aria-hidden="true" aria-labelledby="withdrawModal" role="dialog"
        tabindex="-1">
